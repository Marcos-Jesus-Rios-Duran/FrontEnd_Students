...
const TeacherList = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://10.10.60.31:3000/api/teachers/getAll');
    ...
    const handleUpdate = async () => {
        try {
            await axios.post(`http://10.10.60.31:3000/api/teachers/updateOne/${editTeacher.teacher_number}`, editTeacher);
    ...
    const handleDelete = async (teacherNumber) => {
        try {
            await axios.delete(`http://10.10.60.31:3000/api/teachers/deleteOne/${teacherNumber}`);
